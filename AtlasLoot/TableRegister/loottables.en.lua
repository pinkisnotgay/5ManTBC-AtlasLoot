...
-------------------------
  ...
  --Naxxramas
	...
	AtlasLoot_TableNames["NAXSapphiron"] = { BabbleBoss["Sapphiron"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["NAXKelThuzard"] = { BabbleBoss["Kel'Thuzad"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["NAXTrash"] = { AL["Trash Mobs"].." ("..BabbleZone["Naxxramas"]..")", "AtlasLootItems" };
  --Onyxia's Lair
	AtlasLoot_TableNames["OnyxiaDiff5Loot"] = { BabbleBoss["Onyxia 5"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["OnyxiaDiff6Loot"] = { BabbleBoss["Onyxia 6"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["OnyxiaDiff6LootP2"] = { BabbleBoss["Onyxia 6"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["OnyxiaDiff65Loot"] = { BabbleBoss["Onyxia 6.5"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["OnyxiaDiff65LootP2"] = { BabbleBoss["Onyxia 6.5"], "AtlasLootExpansionItems" };
  --Ragefire Chasm
  ...
  --Temple of Ahn'Qiraj
	...
	AtlasLoot_TableNames["AQ40CThun"] = { BabbleBoss["C'Thun"], "AtlasLootExpansionItems" };
  ...
  --Zul'Farrak
	AtlasLoot_TableNames["ZFAntusul"] = { BabbleBoss["Antu'sul"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFThekatheMartyr"] = { BabbleBoss["Theka the Martyr"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFWitchDoctorZumrah"] = { BabbleBoss["Witch Doctor Zum'rah"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFNekrumGutchewer"] = { BabbleBoss["Nekrum Gutchewer"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFSezzziz"] = { BabbleBoss["Shadowpriest Sezz'ziz"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFDustwraith"] = { BabbleBoss["Dustwraith"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFSergeantBly"] = { BabbleBoss["Sergeant Bly"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFSandfury"] = { BabbleBoss["Sandfury Executioner"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFHydromancerVelratha"] = { BabbleBoss["Hydromancer Velratha"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFGahzrilla"] = { BabbleBoss["Gahz'rilla"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFChiefUkorzSandscalp"] = { BabbleBoss["Chief Ukorz Sandscalp"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFZerillis"] = { BabbleBoss["Zerillis"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["ZFTrash"] = { AL["Trash Mobs"].." ("..BabbleZone["Zul'Farrak"]..")", "AtlasLootExpansionItems" };
  --Zul'Gurub
