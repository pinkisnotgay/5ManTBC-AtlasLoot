...
AtlasLoot_DewDropDown = {
	...
	[2] = {
		[AL["5MAN TBC Instances"]] = {
			...
			[13] = { 
				{ BabbleZone["AQ"], "TempleofAQ", "Submenu" },
			},
			[14] = { 
			...
			[15] = { 
				[BabbleZone["Onyxia"]] = {
					{ BabbleZone["Onyxia Diff 5"], "OnyxiaDiff5", "Submenu" },
					{ BabbleZone["Onyxia Diff 6"], "OnyxiaDiff6", "Submenu" },
					{ BabbleZone["Onyxia Diff 6.5 + CM"], "OnyxiaDiff65", "Submenu" },
				},
			},
...
AtlasLoot_DewDropDown_SubTables = {
	["OnyxiaDiff5"] = {
		{ BabbleBoss["Onyxia 5"], "OnyxiaDiff5Loot" },
   },
   ["OnyxiaDiff6"] = {
	   { BabbleBoss["Onyxia 6 Part 1"], "OnyxiaDiff6Loot" },
	   { BabbleBoss["Onyxia 6 Part 2"], "OnyxiaDiff6LootP2" },
   },
   ["OnyxiaDiff65"] = {
	   { BabbleBoss["Onyxia 6.5 Part 1"], "OnyxiaDiff65Loot" },
	   { BabbleBoss["Onyxia 6.5 Part 2"], "OnyxiaDiff65LootP2" },
   },
	["BlackrockDepths"] = {
