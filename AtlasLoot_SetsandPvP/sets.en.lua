...
-----------------------
	...
	Legendaries = {
		...
		{ 8149, "", "=q5=Voodo Charm", "AQ/Onyxia 6.5+ 4% Normal or 8% CM", ""},
		{ 97600, "", "=q5=Illidari Charm (Mainhand)", "", ""},
		{ 97601, "", "=q5=Illidari Charm (Ofhand)", "", ""},
		{ 97602, "", "=q5=Atiesh Charm", "", ""},
		{ 97603, "", "=q5=Eradar Demon Lord Charm", "", ""},
		{ 0,"","","" },
		{ 21176, "", "=q5=Black Qiraji Resonating Crystal", "850 TOA" },
		{ 21321, "", "=q4=Red Qiraji Resonating Crystal", "Zul'Aman CM Only" },
		{ 0,"","","" },
		{ 57055, "", "=q5=Jump Challenge Winner", "Blue glow", ""},
		{ 57056, "", "=q5=Jump Challenge Winner", "Red glow", ""},
	};
